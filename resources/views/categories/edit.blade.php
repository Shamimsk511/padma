                ...
                <div class="col-md-6">
                    <div class="form-group mt-4 pt-2">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="is_simple_product" name="is_simple_product" value="1" {{ old('is_simple_product', $category->is_simple_product) ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="box_pcs" id="box_pcs" class="form-control" min="1" step="1" value="{{ old('box_pcs', $category->box_pcs) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="mb-1">Tile Width (inch) <span class="text-danger">*</span></label>
                            <input type="number" name="tile_width_in" id="tile_width_in" class="form-control" min="0.01" step="0.01" value="{{ old('tile_width_in', $category->tile_width_in) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="mb-1">Tile Length (inch) <span class="text-danger">*</span></label>
                            <input type="number" name="tile_length_in" id="tile_length_in" class="form-control" min="0.01" step="0.01" value="{{ old('tile_length_in', $category->tile_length_in) }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="pieces_feet" id="pieces_feet" class="form-control" step="0.0001" value="{{ old('pieces_feet', $category->pieces_feet) }}" readonly>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="weight_value" class="form-control" min="0" step="0.001" value="{{ old('weight_value', $category->weight_value) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="weight_unit" class="form-control">
                            ...
                            <option value="per_piece" {{ old('weight_unit', $category->weight_unit) === 'per_piece' ? 'selected' : '' }}>Per Piece</option>
                            <option value="per_box" {{ old('weight_unit', $category->weight_unit) === 'per_box' ? 'selected' : '' }}>Per Box</option>
                            <option value="per_unit" {{ old('weight_unit', $category->weight_unit) === 'per_unit' ? 'selected' : '' }}>Per Unit</option>
                        </select>
                    </div>
                </div>
            </div>
