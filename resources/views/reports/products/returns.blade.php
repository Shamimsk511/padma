        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h4 class="modal-title"><i class="fas fa-undo mr-2"></i>Return Details</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-details', function() {
                ...
                // Update modal title
                $('#returnDetailsModal .modal-title').html(`<i class="fas fa-undo mr-2"></i>Return Details: ${productName}`);
                ...
                $.ajax({
                    url: '{{ route("reports.products.returns.details") }}',
                    type: 'GET',
                    data: {
