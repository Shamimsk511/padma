        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h4 class="modal-title"><i class="fas fa-truck-loading mr-2"></i>Purchase Details</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-details', function() {
                ...
                // Update modal title
                $('#purchaseDetailsModal .modal-title').html(`<i class="fas fa-truck-loading mr-2"></i>Purchase Details: ${productName}`);
                ...
                $.ajax({
                    url: '{{ route("reports.products.purchases.details") }}',
                    type: 'GET',
                    data: {
