        ...
        <div class="card-body">
            <form action="{{ route('expenses.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="expense_date" id="expense_date" class="form-control modern-input" value="{{ old('expense_date', now()->toDateString()) }}" required>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" id="amount" class="form-control modern-input" step="0.01" min="0.01" value="{{ old('amount') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="payment_method" id="payment_method" class="form-control modern-select">
                                ...
                                <option value="mobile_bank" {{ old('payment_method') == 'mobile_bank' ? 'selected' : '' }}>Mobile Banking</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="payment_account_id" id="payment_account_id" class="form-control modern-select" required>
                                ...
                                @foreach($paymentAccounts as $account)
                                    ...
                                    @endphp
                                    <option value="{{ $account->id }}" data-balance="{{ $balanceLabel }}" {{ old('payment_account_id') == $account->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference" id="reference" class="form-control modern-input" value="{{ old('reference') }}">
                </div>

                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" id="description" class="form-control modern-textarea" rows="3">{{ old('description') }}</textarea>
                </div>
