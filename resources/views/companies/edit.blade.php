...
@section('page_content')
    ...
    <form action="{{ route('companies.update', $company) }}" method="POST" id="company-edit-form">
        @csrf
        @method('PUT')

        <div class="card modern-card">
            <div class="card-header modern-header">
                <h3 class="card-title"><i class="fas fa-building"></i> Edit Company</h3>
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="section-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type"
                                            ...
                                            required>
                                        <option value="supplier" {{ old('type', $company->type ?? 'supplier') === 'supplier' ? 'selected' : '' }}>Supplier</option>
                                        <option value="brand" {{ old('type', $company->type) === 'brand' ? 'selected' : '' }}>Brand</option>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="description"
                                              ...
                                              maxlength="500">{{ old('description', $company->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="section-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="opening_balance_direction"
                                        ...
                                        @php
                                            $direction = old('opening_balance_direction');
                                            if (!$direction) {
                                                $direction = ($company->opening_balance_type ?? 'credit') === 'debit' ? 'they_owe' : 'we_owe';
                                            }
                                        @endphp
                                        <option value="we_owe" {{ $direction === 'we_owe' ? 'selected' : '' }}>
                                            We owe this supplier
                                        </option>
                                        <option value="they_owe" {{ $direction === 'they_owe' ? 'selected' : '' }}>
                                            Supplier owes us
                                        </option>
                                    </select>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea name="address"
                                              ...
                                              maxlength="300">{{ old('address', $company->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
