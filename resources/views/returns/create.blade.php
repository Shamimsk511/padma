...
@section('page_title', 'Create New Product Return')
...
@section('page_content')
    ...
    <form action="{{ route('returns.store') }}" method="POST" id="return-form">
        ...
        <!-- Return Details (match invoice create layout) -->
        <div class="card modern-card mb-4">
            <div class="card-header modern-header">
                <h3 class="card-title"><i class="fas fa-undo"></i> Return Details</h3>
                <div class="card-tools">
                    <button type="button" class="btn btn-sm btn-light" id="customer-history-btn" style="display: none;">
                    ...
                    <div class="col-md-5">
                        <div class="info-section">
                            <div class="section-header">
                                <i class="fas fa-info-circle"></i> Return Info
                            </div>
                            <div class="section-content">
                                <div class="form-group">
                                    <label for="return_number">Return Number</label>
                                    <input type="text" name="return_number" id="return_number" class="form-control modern-input" value="{{ $return_number }}" readonly>
                                    <small class="form-text">Auto-generated</small>
                                </div>
                                <div class="form-group">
                                    <label for="return_date">Return Date <span class="required">*</span></label>
                                    <input type="date" name="return_date" id="return_date" class="form-control modern-input" value="{{ $return_date }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-success add-btn" data-toggle="modal" data-target="#newCustomerModal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customer_address" class="form-control modern-input" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <table class="table modern-table compact-table" id="product-table">
                ...
                <tbody>
                    <tr class="product-row">
                        ...
                        <td>
                            <input type="text" name="description[]" class="form-control modern-input compact-input product-description" required>
                        </td>
                        <td>
                            <input type="text" class="form-control modern-input compact-input product-company" readonly>
                        </td>
                        <td>
                            <input type="text" class="form-control modern-input compact-input product-category" readonly>
                        </td>
                        <td>
                            <input type="number" class="form-control modern-input compact-input product-available" readonly>
                            <small class="text-muted available-info"></small>
                        </td>
                        <td>
                            <input type="number" name="quantity[]" class="form-control modern-input compact-input product-quantity" step="0.01" min="0.01" required>
                        </td>
                        <td>
                            <input type="number" name="boxes[]" class="form-control modern-input compact-input product-boxes" readonly>
                        </td>
                        <td>
                            <input type="number" name="pieces[]" class="form-control modern-input compact-input product-pieces" readonly>
                        </td>
                        <td>
                            <input type="number" name="unit_price[]" class="form-control modern-input compact-input product-price" step="0.01" min="0" required>
                        </td>
                        <td>
                            <input type="number" name="item_total[]" class="form-control modern-input compact-input product-total" step="0.01" min="0" readonly required>
                        </td>
                        <td>
                ...
                <div class="card modern-card">
                    ...
                    <div class="card-body modern-card-body">
                        ...
                        <div class="info-item">
                            ...
                            <input type="number" name="refund_amount" id="refund_amount" class="form-control modern-input" step="0.01" min="0" value="0">
                        ...
                        <div class="info-item">
                            ...
                            <textarea name="notes" id="notes" class="form-control modern-input" rows="4" placeholder="Add any additional notes..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card modern-card">
                    ...
                    <div class="card-body modern-card-body">
                        <div class="info-item">
                            ...
                            <input type="number" name="subtotal" id="subtotal" class="form-control modern-input amount-display" step="0.01" min="0" readonly required>
                        </div>
                        <div class="info-item">
                            <div class="info-label">
...
/* Compact table styles (match invoice create) */
.compact-table {
    font-size: 13px;
}
...
$(document).ready(function() {
    ...
    function loadProductDetails(productId, row) {
        $.ajax({
            url: '/returns/product-details/' + productId, // FIXED URL
            type: 'GET',
            dataType: 'json',
    ...
    // FIXED: Load available quantity for return
    ...
    // FIXED: Load customer details
    function loadCustomerDetails(customerId) {
        $.ajax({
            url: '/returns/customer-details/' + customerId, // FIXED URL
            type: 'GET',
            dataType: 'json',
            success: function(data) {
    ...
    // FIXED: Load customer purchase history
    function loadCustomerPurchaseHistory(customerId) {
        ...
        $.ajax({
            url: '/returns/customer-purchase-history/' + customerId, // FIXED URL
            type: 'GET',
            dataType: 'json',
            beforeSend: function() {
            ...
            success: function(response) {
                console.log('Purchase history response:', response); // DEBUG
                
                if (response.success) {
                    customerPurchaseHistory = response.products || {};
                    
                    console.log('Stored purchase history:', customerPurchaseHistory); // DEBUG
            ...
            error: function(xhr, status, error) {
                ...
                $('#customer-history-content').html(`
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle"></i>
                        Error loading purchase history: ${error}. Please try again.
                    </div>
                `);
                customerPurchaseHistory = {};
            }
    ...
    // FIXED: Update history modal content
    function updateHistoryModalContent(data) {
        const products = data.products || {};
        const summary = data.summary || {};
        
        console.log('Updating modal with products:', products); // DEBUG
    ...
    function showValidationWarnings() {
        ...
        content += '<p class="text-muted"><small>This action will create the return record regardless of purchase history validation.</small></p>';
