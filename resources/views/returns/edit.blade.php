                ...
                <div class="card modern-card">
                    ...
                    <div class="card-body modern-card-body">
                        ...
                        <div class="info-item">
                            ...
                            <input type="number" name="total" id="total" class="form-control modern-input amount-display" step="0.01" min="0" value="{{ $return->total }}" readonly required>
                        </div>
                        <div class="info-item">
                            <div class="info-label">
                                <i class="fas fa-percent text-warning"></i> Deduction %
                            </div>
                            <input type="number" name="deduction_percent" id="deduction_percent" class="form-control modern-input" step="0.01" min="0" max="100" value="{{ $return->deduction_percent ?? 0 }}">
                        </div>
                        <div class="info-item">
                            <div class="info-label">
                                <i class="fas fa-minus-circle text-warning"></i> Deduction Amount
                            </div>
                            <input type="number" id="deduction_amount_display" class="form-control modern-input amount-display" step="0.01" readonly value="{{ number_format($return->deduction_amount ?? 0, 2, '.', '') }}">
                        </div>
                        <div class="info-item">
                            <div class="info-label">
                                <i class="fas fa-check-circle text-danger"></i> Net Return Amount
                            </div>
                            <input type="number" id="net_total_display" class="form-control modern-input amount-display total-highlight" step="0.01" readonly value="{{ number_format($return->net_total, 2, '.', '') }}">
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function updateStatsCards() {
        const total = parseFloat($('#net_total_display').val()) || parseFloat($('#total').val()) || 0;
